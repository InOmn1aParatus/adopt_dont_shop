  ...
  describe 'class methods' do
    ...
    describe '#has_pending_applications' do
      it 'lists only shelters with pending applications' do
        ...
        pet_app1 = PetApplication.create(pet: @pet_2, application: app1, status: 'Pending')
